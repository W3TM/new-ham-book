...
A set of adjacent frequencies usually identified by their approximate wavelength in meters, as in the 40 meter (40m) band.
...
Megahertz. A unit of frequency. 1 MHz is 1 million cycles/sec or 1 million Hertz (Hz). The 'H' is capitalized because it is named after [Henrich Hertz](https://en.wikipedia.org/wiki/Heinrich_Hertz).

### MUF {-}

Maximum useable frequency at a given point in time and location on Earth.
...
Power. $P=IE=I^2R$. Power is usually measured in watts ([W](lingo.qmd#w)) or some multiple of watts (e.g, kilowatts or kW).
...
Watts. A unit of power. Named after James Watt

### WSJT-X {-}

A free weak signal digital mode application for computer to computer communications, available at <https://wsjt.sourceforge.io/wsjtx.html>
